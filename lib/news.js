...
async function getNews(apiKey) {
    ...
    try {
        ...
        console.error("News provider error:", errorCode, error.status || "network");
        const fallback = { items: demoNews, live: false, fallback: true, errorCode, message: "Live provider unavailable — safe demo fallback active." };
